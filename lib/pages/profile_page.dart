...
class _ProfilePageState extends State<ProfilePage> {
  List<String> fields = ["Name: ", "Email: ", "Phone No: ", "Designation: "];
  List<String> details = ["name", "email", "phNumber", "role"];
  QuerySnapshot? snap;
  String? employeeId;
  File? file;
  UploadTask? task;
  ...
  Future<void> uploadFile(String link) async {
    ...
    final destination = 'AdminFiles/$fileName';
